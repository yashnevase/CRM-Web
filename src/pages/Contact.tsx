      ...
      <section className="section-space bg-surface">
        <div className="page-shell grid gap-10 lg:grid-cols-[.8fr_1.2fr]">
          ...
          <form
            ...
            className="rounded-3xl border border-line bg-canvas p-6 shadow-card sm:p-8"
          >
            <h2 className="text-2xl font-bold">Request an appointment</h2>
            <div className="mt-7 grid gap-5 sm:grid-cols-2">
              {fields.map((field, index) => (
                <label key={field} className={index === 2 ? 'sm:col-span-2' : ''}>
            ...
            <button className="focus-ring mt-6 inline-flex min-h-12 items-center gap-2 rounded-full bg-primary px-6 text-sm font-bold text-white shadow-glow">
              Send request
